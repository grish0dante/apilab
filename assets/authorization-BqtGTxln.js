import{u as t,j as s}from"./entry.client-B4pFekiz.js";const h="This section describes how to access the protected resources of the Financial System API.",a=[{depth:2,text:"SDK Usage Example",id:"sdk-usage-example"}],l={title:"Authorization",lastModifiedTime:"2026-04-14T07:57:34.000Z"},o="pages/authorization.mdx";function n(i){const e={code:"code",h2:"h2",p:"p",pre:"pre",span:"span",strong:"strong",...t(),...i.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.p,{children:"This section describes how to access the protected resources of the Financial System API."}),`
...
`,s.jsxs(e.p,{children:[`Status Code	Description	Reason\r
| :--- | :--- | :--- |\r
...
//# sourceMappingURL=authorization-BqtGTxln.js.map
